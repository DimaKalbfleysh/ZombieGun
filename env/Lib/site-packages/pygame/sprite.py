...
class DirtySprite(Sprite):
    ...
    source_rect = None
        ...
        move_left corner (0, 0) of self.image.
...
class LayeredUpdates(AbstractGroup):
    ...
    def add_internal(self, sprite, layer=None):
        ...
        # add the sprite at the move_right position
        # bisect algorithmus
        leng = len(sprites)
        low = mid = 0
        high = leng - 1
    ...
    def draw(self, surface):
        """draw all sprites in the move_right order onto the passed surface
...
class LayeredDirty(LayeredUpdates):
    ...
    def draw(self, surface, bgd=None):
        """draw all sprites in the move_right order onto the given surface
...
def collide_rect(left, right):
    ...
    pygame.sprite.collide_rect(move_left, move_right): return bool
...
class collide_rect_ratio:
    ...
    def __call__(self, left, right):
        ...
        pygame.sprite.collide_rect_ratio(ratio)(move_left, move_right): return bool
...
def collide_circle(left, right):
    ...
    pygame.sprite.collide_circle(move_left, move_right): return bool
...
class collide_circle_ratio(object):
    ...
    def __call__(self, left, right):
        ...
        pygame.sprite.collide_circle_radio(ratio)(move_left, move_right): return bool
