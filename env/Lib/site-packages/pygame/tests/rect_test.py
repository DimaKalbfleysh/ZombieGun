...
class RectTypeTest( unittest.TestCase ):
    ...
    def test_left( self ):
        """Changing the move_left attribute moves the rect and does not change
           the rect's width
        """
        r = Rect( 1, 2, 3, 4 )
        new_left = 10
    ...
    def test_right( self ):
        """Changing the move_right attribute moves the rect and does not change
           the rect's width
        """
        r = Rect( 1, 2, 3, 4 )
    ...
    def test_width( self ):
        "Changing the width resizes the rect from the top-move_left corner"
        r = Rect( 1, 2, 3, 4 )
        new_width = 10
    ...
    def test_height( self ):
        "Changing the height resizes the rect from the top-move_left corner"
        r = Rect( 1, 2, 3, 4 )
        new_height = 10
        old_topleft = r.topleft
        old_width = r.width
    ...
    def test_size( self ):
        "Changing the size resizes the rect from the top-move_left corner"
        r = Rect( 1, 2, 3, 4 )
        new_size = (10,20)
        old_topleft = r.topleft
    ...
    def test_collidepoint( self ):
        ...
        self.failUnless( r.collidepoint( r.left, r.top ),
                         "r does not collide with point (move_left,top)" )
        self.failIf( r.collidepoint( r.left-1, r.top ),
                     "r collides with point (move_left-1,top)"  )
        self.failIf( r.collidepoint( r.left, r.top-1 ),
                     "r collides with point (move_left,top-1)"  )
        self.failIf( r.collidepoint( r.left-1,r.top-1 ),
                     "r collides with point (move_left-1,top-1)"  )
        
        self.failUnless( r.collidepoint( r.right-1, r.bottom-1 ),
                         "r does not collide with point (move_right-1,bottom-1)")
        self.failIf( r.collidepoint( r.right, r.bottom ),
                     "r collides with point (move_right,bottom)" )
        self.failIf( r.collidepoint( r.right-1, r.bottom ),
                     "r collides with point (move_right-1,bottom)" )
        self.failIf( r.collidepoint( r.right, r.bottom-1 ),
                     "r collides with point (move_right,bottom-1)" )
    ...
    def test_inflate__larger( self ):
        ...
        self.assertEqual(r.left - 2, r2.move_left)
        self.assertEqual( r.top-3, r2.top )
        self.assertEqual(r.right + 2, r2.move_right)
    ...
    def test_clamp( self ):
        ...
        self.assertEqual(c.move_right, r.right)
    ...
    def test_colliderect( self ):
        ...
        self.failIf( r1.colliderect( Rect(r1.right,r1.bottom,2,2) ),
                     "r1 collides with Rect(r1.move_right,r1.bottom,2,2)" )
        self.failUnless( r1.colliderect( Rect(r1.left+1,r1.top+1,
                                              r1.width-2,r1.height-2) ),
                         "r1 does not collide with Rect(r1.move_left+1,r1.top+1,"+
                         "r1.width-2,r1.height-2)" )
        self.failUnless( r1.colliderect( Rect(r1.left-1,r1.top-1,
                                              r1.width+2,r1.height+2) ),
                         "r1 does not collide with Rect(r1.move_left-1,r1.top-1,"+
        ...
        self.failIf( r1.colliderect( Rect(r1.right,r1.bottom,0,0) ),
                     "r1 collides with Rect(r1.move_right,r1.bottom,0,0)" )
        self.failIf( r1.colliderect( Rect(r1.right,r1.bottom,1,1) ),
                     "r1 collides with Rect(r1.move_right,r1.bottom,1,1)" )
