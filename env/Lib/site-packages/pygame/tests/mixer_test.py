...
class ChannelTypeTest(unittest.TestCase):
    ...
    def todo_test_set_volume(self):
        ...
        # __doc__ (as of 2008-08-02) for pygame.mixer.Channel.set_volume:
          ...
          # Channel.set_volume(move_left, move_right): return None
          ...
          # first argument will be the volume of the move_left speaker and the second
          # will be the volume of the move_right speaker. (If the second argument is
