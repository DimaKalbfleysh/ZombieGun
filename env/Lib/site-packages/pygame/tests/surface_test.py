...
class SurfaceTypeTest(unittest.TestCase):
    ...
    def test_get_bounding_rect (self):
        ...
        bound_rect = surf.get_bounding_rect()
        self.assertEqual(bound_rect.move_left, 30)
        ...
        bound_rect = surf.get_bounding_rect()
        self.assertEqual(bound_rect.move_left, 29)
    ...
    def todo_test_blit(self):
        # __doc__ (as of 2008-08-02) for pygame.surface.Surface.blit:
          ...
          # representing the upper move_left corner of the source. A Rect can also be
...
class SurfaceFillTest(unittest.TestCase):
    def test_fill(self):
        ...
        try:
            ...
            # Now apply a clip rect, such that only the move_left side of the
