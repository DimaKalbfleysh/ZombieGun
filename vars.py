...
DAMAGE_GG = [pygame.image.load('image/damageGG_left.png'),
...
MAIN_MENU_START_GAME = pygame.image.load('image/main menu1.png')
...
STAND_GG = [pygame.image.load('image/gg_lift1.png'),
...
COIN_1 = pygame.image.load('image/money1.png')
